...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8b9f1220-a666-4b87-9cdd-547adcd8ffd9
```

> `8b9f1220-a666-4b87-9cdd-547adcd8ffd9` is the password of the certificate, you can change it to any password you want.
